...
class AnchorTargetLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        if DEBUG:
            print
            'AnchorTargetLayer: height', height, 'width', width
    ...
    def forward(self, bottom, top):
        ...
        if DEBUG:
            ...
            print
            'rpn: gt_boxes.shape', gt_boxes.shape
            print
            'rpn: gt_boxes', gt_boxes
        ...
        if DEBUG:
            ...
            self._count += 1
            print
            'rpn: num_positive avg', self._fg_sum / self._count
            print
            'rpn: num_negative avg', self._bg_sum / self._count
