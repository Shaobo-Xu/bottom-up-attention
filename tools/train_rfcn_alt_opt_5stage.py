...
def rpn_generate(queue=None, imdb_name=None, rpn_model_path=None, cfg=None,
    ...
    print
    'RPN model: {}'.format(rpn_model_path)
    print('Using config:')
    pprint.pprint(cfg)
    ...
    imdb = get_imdb(imdb_name)
    print
    'Loaded dataset `{:s}` for proposal generation'.format(imdb.name)
    ...
    print
    'Wrote RPN proposals to {}'.format(rpn_proposals_path)
...
if __name__ == '__main__':
    ...
    print
    'Final model: {}'.format(str(rfcn_stage2_out['model_path']))
    print
    'Final RPN: {}'.format(str(rpn_stage3_out['test_proposal_path']))
